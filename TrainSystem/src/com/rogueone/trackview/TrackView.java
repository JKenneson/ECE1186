...
//        new TrackView(Global.Line.GREEN);
    ...
    private void initializeGreenLine() {
        ...
        Station stationMtLebanon = new Station(240, 70, 10);
        sp.addShape(stationMtLebanon);
        Station stationPoplar = new Station(210, 155, 13);
        sp.addShape(stationPoplar);
        Station stationOverbrook1 = new Station(530, 48, 13);
        sp.addShape(stationOverbrook1);
        Station stationInglewood1 = new Station(580, 48, 13);
        sp.addShape(stationInglewood1);
        Station stationCastleShannon = new Station(252, 175, 13);
        sp.addShape(stationCastleShannon);
        Station stationSouthBank = new Station(765, 48, 13);
        sp.addShape(stationSouthBank);
        Station stationWhited = new Station(767, 100, 13);
        sp.addShape(stationWhited);
        Station stationUniOfPitt = new Station(767, 175, 13);
        sp.addShape(stationUniOfPitt);
        Station stationEdgebrook = new Station(710, 245, 13);
        sp.addShape(stationEdgebrook);
        Station stationPioneer = new Station(795, 245, 13);
        sp.addShape(stationPioneer);
        Station stationOverbrook2 = new Station(865, 48, 13);
